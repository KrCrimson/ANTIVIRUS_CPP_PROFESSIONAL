"""
Pydantic schemas for request/response validation (Extended for Multi-Instance)
===============================================================================
...
class AntivirusInstanceCreate(BaseModel):
    """Schema for creating/registering a new antivirus instance"""
    
    # Required ID (UUID) - generated by client on first install
    id: str = Field(..., min_length=36, max_length=36, description="Unique instance UUID")
    
    # Optional instance metadata
    hostname: Optional[str] = Field(None, max_length=255, description="Computer hostname")
    os_info: Optional[str] = Field(None, max_length=200, description="Operating system information")
...
class AntivirusInstanceUpdate(BaseModel):
    """Schema for updating an existing instance (used on every log submission)"""
    
    hostname: Optional[str] = Field(None, max_length=255)
    os_info: Optional[str] = Field(None, max_length=200)
    antivirus_version: Optional[str] = Field(None, max_length=50)
    ip_address: Optional[str] = Field(None, max_length=45)
    mac_address: Optional[str] = Field(None, max_length=17)
    status: Optional[InstanceStatus] = Field(None)
    metadata: Optional[Dict[str, Any]] = Field(None)


class AntivirusInstanceResponse(BaseModel):
    ...
    log_count: Optional[int] = None  # Total logs from this instance
...
class LogEntryCreate(BaseModel):
    ...
    # Instance ID (recommended for multi-instance tracking)
    instance_id: Optional[str] = Field(None, max_length=36, description="Antivirus instance UUID")
    
    # Optional source information (legacy)
...
class LogEntryResponse(BaseModel):
    ...
    instance: Optional[Dict[str, Any]] = None  # Nested instance info
...
class LogStatisticsResponse(BaseModel):
    ...
    logs_by_instance: Dict[str, int]  # NEW: Logs count per instance
...
class HealthCheckResponse(BaseModel):
    ...
    total_instances: int = Field(..., description="Total instances registered")
